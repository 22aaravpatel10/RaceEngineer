        ...
        <div className="w-full h-full overflow-y-auto p-6 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {data.sessions.map((sess, idx) => (
                    <div key={idx} className="bg-card rounded-xl p-4 border border-white/5 shadow-lg flex flex-col">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex-1">
                                    <table className="w-full text-sm">
                                        ...
                                        <tbody>
                                            {sess.results?.slice(0, 5).map((r) => (
                                                <tr key={r.position} className="group hover:bg-white/5 transition-colors">
